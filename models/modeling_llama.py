...
class LlamaModel(LlamaPreTrainedModel):
    ...
    def forward(
        ...
        if prompt_embedding is not None:
            ...
            prompt_padding = torch.zeros(bsz, seq_length - n_prompt_tokens, prompt_dim).to(
                inputs_embeds.device)
...
class LlamaForCausalLM_bak(LlamaPreTrainedModel):
...
class LlamaForCausalLM(LlamaPreTrainedModel):
    ...
    def score_state_dict(self):
        return self.score.state_dict()
    
    def load_score_state_dict(self, state):
        self.score.load_state_dict(state)
