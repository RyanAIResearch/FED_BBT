...
f_name_fl = 'fl_noniid_alpha0.5_kshot40_frac1_lpop{}_upper_non_change'.format(popsize)
# f_name_fedavg = 'fedavg_noniid_alpha1_kshot40_frac1_lpop{}'.format(popsize)

# f_name_fl = 'fl_iid_kshot40_frac1_lpop{}'.format(popsize)
...
sigma_cent = sigma_cent[:end]
sigma_fl = sigma_fl[:end]
...
pyplot.legend(["Centralized", "FedBBT"])
pyplot.ylabel("sigma")
pyplot.xlabel("communication round")
pyplot.savefig("sigma_noniid_pop{}_upper.jpg".format(popsize))