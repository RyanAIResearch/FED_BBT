...
f_name_cent = '../central_kshot500_lpop{}'.format(popsize)

f_name_fl = 'new_fl_noniid_alpha0.5_kshot40_frac1_lpop{}'.format(popsize)
f_name_fedavg = '../fedavg_noniid_alpha0.5_kshot500_frac1_lpop{}'.format(popsize)
...
pyplot.savefig("noniid_pop{}.jpg".format(popsize))